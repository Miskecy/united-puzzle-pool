...
import { XCircle, Key, RefreshCw, ClipboardPaste } from 'lucide-react'

export default function BlockSolutionSubmit({ blockId, rangeStart, rangeEnd }: { blockId: string, rangeStart?: string, rangeEnd?: string }) {
  ...
  return (
    <Card className="bg-white border-gray-200 shadow-md">
      <CardHeader className='border-b pb-4'>
        ...
        <CardDescription className='text-gray-600'>Paste and submit your found private keys{rangeStart && rangeEnd ? ` for ${rangeStart}…${rangeEnd}` : ''}.</CardDescription>
      </CardHeader>
      <CardContent className='pt-6'>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <textarea
            ...
            className="w-full min-h-[220px] px-3 py-2 border border-gray-300 rounded text-sm font-mono focus:outline-none focus:ring-2 focus:ring-purple-600"
