-- AlterTable to add puzzle_name_snapshot column
...
INSERT INTO "new_block_assignments" ("id","user_token_id","start_range","end_range","checkwork_addresses","status","expires_at","puzzle_address_snapshot","puzzle_name_snapshot","created_at","updated_at")
SELECT "id","user_token_id","start_range","end_range","checkwork_addresses","status","expires_at","puzzle_address_snapshot",NULL,"created_at","updated_at" FROM "block_assignments";
